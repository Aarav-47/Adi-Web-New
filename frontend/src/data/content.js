...
export const T = {
  en: {
    ...
    event: {
      ...
      address: "House No A/9, Biscoman Colony,\nInfront Of BPS ITI, East From Kumhrar,\nPatna \u2013 800007",
    ...
    family: {
      ...
      greatgrandparents: "Grandparents",
  ...
  hi: {
    ...
    welcomeMsg: {
      ...
      body: "आगामी 19 मई को हमारा परिवार एक नई पूर्णता में बदल जाएगा। हम आप सभी को हमारी प्यारी अदित्री आर्या के पावन छठी समारोह में सादर आमंत्रित करते हैं — आशीर्वाद, मधुर संगीत, कोमल मुस्कुराहटों और असीम प्रेम से भरी एक संध्या। आपकी उपस्थिति ही हमारा सबसे बड़ा उपहार है।",
    ...
    event: {
      ...
      address: "मकान सं॰ A/9, बिस्कोमान कॉलोनी,\nBPS ITI के सामने, कुम्हरार के पूर्व में,\nपटना – 800007",
    ...
    family: {
      ...
      greatgrandfather: "श्री केशवर प्रसाद",
      ampersand: "एवं",
    },
    blessings: {
